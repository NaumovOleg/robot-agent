...
const baseState = (overrides: Record<string, unknown>) =>
  ({
    plan: {
      ...
      steps: [{ id: 'edit-a', kind: 'edit', title: 't', files: ['src/a.ts'], depends_on: [], expected_output: 'e' }],
    },
    cwd: '/tmp', sessionId: 's', currentStepId: 'edit-a',
    stepStates: { 'edit-a': 'running' }, stepResults: [], currentHints: [],
    readerFindings: {}, fileSnapshots: {}, retryCounts: {}, appliedOps: { 'edit-a': ['rename_symbol src/a.ts'] },
    lastError: null, userGuidance: null, verifyOutput: null, verifyPassed: null, escalationDecision: null,
