...
import { hasRipgrep, searchWithRipgrep, searchWithGrep, formatMatches } from '../../utils';
...
export const searchFilesTool = tool(
  async (
    ...
    try {
      ...
      const matches = await (useRg
        ? searchWithRipgrep(pattern, cwd, { ...params, contextLines: CONTEXT_LINES })
        : searchWithGrep(pattern, cwd, params));
